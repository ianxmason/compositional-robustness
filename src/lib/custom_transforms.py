"""
We want to be able to augment data in the same way across corruptions

This means we want RandomCrop & RandomHorizontalFlip, to perform the same sequence of choices across datasets
e.g. Flip, No Flip, No Flip, Flip (for first 4 images in the dataset, and the same every time)
...
class SemiRandomHorizontalFlip(object):
