...
# Set time to 5:00:00 before parallelizing
...
singularity exec --nv -B /om,/om2/user/$USER /om/user/xboix/singularity/xboix-tensorflow2.8.0.simg \
                python iteration_test_compositions_residual_invariance.py \
                                                          --pin-mem \
                                                          --check-if-run \
                                                          --experiment-name "split-net-localized-resads-high-capacity-and-bn-no-bn"